...
def download_dataset():
    ...
    response = requests.post(
        f"{BASE_URL}/datasets/download_from_network",
        json={
...
def list_jobs():
    ...
    response = requests.get(f"{BASE_URL}/training/list")
    response.raise_for_status()
...
def cancel_job(job_id: str):
    ...
    response = requests.post(f"{BASE_URL}/training/cancel/{job_id}")
    response.raise_for_status()
    return response.json()
